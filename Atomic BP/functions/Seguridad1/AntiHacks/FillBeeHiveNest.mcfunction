#ANTIHACKS PARA BEEHIVE Y BEENEST BLOCK
...
execute at @a[scores={FillBeeHiveNest=2}] run fill ~8~8~8 ~-8~-1~-8 composter ["composter_fill_level"=8] replace bee_nest
tag @e[type=item,name="Bone Meal"] add NoBee
execute at @a[scores={FillBeeHiveNest=2}] run fill ~8~8~8 ~-8~-1~-8 bee_nest replace composter ["composter_fill_level"=8]
